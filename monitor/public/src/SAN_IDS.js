...
(function(){
  ...
  function addTopoIncident(attacker) {
    $('#code').prepend("<div style='margin-top: 8px;' class='row'><div class='col-md-3'><span class='label label-default'>" + getTime() + "</span></div><div class='col-md-5'><span class='label label-danger'>Link Spoofing</span></div><div class='col-md-4'><span class='label label-danger'>" + attacker + "</span></div></div>")
  }
