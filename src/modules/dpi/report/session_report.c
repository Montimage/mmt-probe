...
static inline void _print_ip_session_report (const mmt_session_t * dpi_session, session_stat_t * session_stat, const dpi_context_t *context){
	uint64_t ul_packets = get_session_total_ul_cap_packet_count(dpi_session);
	uint64_t dl_packets = get_session_total_dl_cap_packet_count(dpi_session);
	...
	uint64_t ul_volumes = get_session_total_ul_cap_byte_count(dpi_session);
	uint64_t dl_volumes = get_session_total_dl_cap_byte_count(dpi_session);
