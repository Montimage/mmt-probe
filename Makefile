...
#set of library
LIBS     := -L/opt/mmt/dpi/lib -L/opt/mmt/security/lib -L/usr/local/lib -lmmt_core -lmmt_tcpip -lmmt_security -lmmt_security2 -lxml2 -lconfuse -lhiredis -lpthread -lrdkafka -lrt
